<div class="flex items-center justify-center h-screen">
    <div class="flex flex-row space-x-10 shadow-2xl offset-x-10 rounded-4xl">
        <div class="w-full text-[#16302B] flex flex-col items-center justify-center pl-15 py-30 rounded-4xl space-y-5">
            ...
            <form class="flex flex-col space-y-3 w-full">
                <x-form-input wire:model type="text" id="name" width="full" name="name" placeholder="Name" border="dark"/>
                ...
                <x-form-input wire:model type="password" id="confirm-password" width="full" name="confirm-password" placeholder="Confirm Password" border="dark"/>
                <div class="flex items-start justify-between space-x-2">
                    <a href="/login">Sudah punya akun? login disini.</a>
                    {{-- BUAT KOMPONEN INPUT BUTTON --}}
                    <x-form-input-btn wire:click="login" width="1/3">Sign Up</x-form-input-btn>
                </div>
            </form>
        </div>
        <div class="bg-[#16302B] text-white w-2/5 flex flex-col items-start justify-center px-10 py-30 rounded-4xl">
            ...
            <p class="text-3lg">Daftar untuk mendapatkan info terkait koleksi fashion terkini dari District.</p>
        </div>
    </div>
</div>
